<template>
  <div class="cart">
    ...
    <CartList :cartList='cartList' :changeStatus='changeStatus' />
    <!-- <CartFoot :isAllChecked.sync='isAllChecked' @changeAllStatus='changeAllStatus'  :totalObj='totalObj' /> -->
    <CartFoot :isAllChecked.sync='isAllChecked'  :totalObj='totalObj' />
  </div>
</template>
...
export default {
  data() {
    return {
      cartList: [
        {
          id: "16t2w3",
          goodsName: "绿箭（DOUBLEMINT）无糖薄荷糖原味薄荷味约35粒23.8g单盒金属装 办公室休闲零食（新旧包装随机发货）",
          goodsPrice: 70.00,
          numbers: 1,
          goodsImg: "https://img13.360buyimg.com/n0/s80x80_jfs/t1/220993/1/1127/187461/616fe92bE860d59e5/56a7ddc20c81ebdc.jpg.dpg",
          status: true
        },
        {
          id: "1223w3",
          goodsName: "绿箭（DOUBLEMINT）无糖薄ada荷糖原味asd薄荷味约35粒23.8g单盒",
          goodsPrice: 80.9,
          numbers: 2,
          goodsImg: "https://img13.360buyimg.com/n0/s80x80_jfs/t1/220993/1/1127/187461/616fe92bE860d59e5/56a7ddc20c81ebdc.jpg.dpg",
          status: true
        ...
        {
          id: "121w3",
          goodsName: "绿箭（DOUBLEMINT）无糖薄ada荷糖原味薄荷ada味约35粒23.8g单盒",
          goodsPrice: 107.9,
          numbers: 3,
          goodsImg: "https://img13.360buyimg.com/n0/s80x80_jfs/t1/220993/1/1127/187461/616fe92bE860d59e5/56a7ddc20c81ebdc.jpg.dpg",
          status: true
  ...
  computed: {
    ...
    totalObj(){
      return  this.cartList.reduce((res, ele)=> {
        const {status, numbers, goodsPrice} = ele
        const checkedNums = status ? numbers + res.checkedNums : res.checkedNums
